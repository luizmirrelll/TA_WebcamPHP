...
<head>
  ...
  <title>Perumahan Permata Buah Batu </title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b style="font-size:16px;">Perumahan Permata Buah Batu</b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <img src="images/<?php echo $data_u['foto']; ?>" class="img-circle" alt="User Image">
                ...
                <p>
                  Anda login sebagai, <?php echo $data_u['level']; ?><!-- session utk mengetahui user-->
                </p>
                <p>
                  ( <?php echo $data_u['nama']; ?> )
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  ...
                  <a href="?page=pengguna&aksi=ubah&id=<?php echo $data_u['id'];?>" class="btn btn-default btn-flat">Ubah Profil</a>
                </div>
              </li>
            </ul>
          </li>
...
<?php $tgl2 = date('Y'); ?>
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo $tgl2; ?> Aloysius Mirel</a>.</strong> All rights
    reserved.
  </footer>
